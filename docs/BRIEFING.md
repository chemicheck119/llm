...
```text
2020 Top-1: 0.3246 → 0.6706
2020 Top-3: 0.3461 → 0.6754
잘못된 단일 CAS 확정: 0건 → 0건
처음 보는 표현 60건 Top-1: 0.2833 → 0.2833
```

즉, 공개 소방 기록에서 반복되는 현장 표현을 더 잘 찾게 됐지만 새로운 표현까지 이해하는
범용 언어모델이 된 것은 아닙니다. 결과는 계속 후보이며 현장 확인 전 충돌 규칙에 넣지 않습니다.
...
적응학습을 실제 수행해 2020 잠금셋 Top-1을 0.3246에서 0.6706으로 높였습니다. 반면 실제
