...
해당 artifact의 schema는 `resolver-char-tfidf-v4-incident-catalog-expanded`이며 runtime manifest에
...
통과하면 `artifacts/resolver.joblib`을 v4로 교체한 후 평가와 runtime manifest를 생성합니다.
